...
return [
   ...
   ['label'=>'用户管理','url'=>'#','module'=>'user','icon'=>'icon-group','submenu'=>[
    ...
    ['label'=>'评论管理','url'=>'#','module'=>'comment','icon'=>'icon-search','submenu'=>[
        ['label'=>'评论列表','url'=>'comments'],
    ]],
    ['label'=>'订单管理','url'=>'#','module'=>'order','icon'=>'icon-edit','submenu'=>[
        ['label'=>'订单列表','url'=>'list'],
    ]],
    ['label'=>'权限管理','url'=>'#','module'=>'rbac','icon'=>'icon-user','submenu'=>[
